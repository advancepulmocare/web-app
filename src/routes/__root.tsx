  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/60f40ef0-52ed-44e2-aead-a67ba64a414c/id-preview-15f60f5d--93893c56-8b22-4cde-abfc-d0547cce6b37.lovable.app-1783194963499.png",
      },
      {
        name: "twitter:image",
        content:
